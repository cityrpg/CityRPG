...
function gameConnection::setGameBottomPrint(%client)
{
	...
	%client.CityRPGPrint = %client.CityRPGPrint @ "<bitmap:" @ $City::DataPath @ "ui/health_red.png>\c6" SPC %health @ "%";

	%client.CityRPGPrint = %client.CityRPGPrint @ " <bitmap:" @ $City::DataPath @ "ui/cash_green.png>" SPC %client.getCashString();
